...
Inside, both `frontend/` and `backend` folders can be found.  
You need to `cd` on each to install dependencies.  

NOTE: Both frontend and backend needs `node version 20` to run properly.
